[IDA IPython](https://github.com/james91b/ida_ipython) is used in the examples unless stated otherwise. For brevity, assume the following code precedes any example code.
